#ifndef __CONFIG_USERS_PERSON_HPP__
#define __CONFIG_USERS_PERSON_HPP__
...
struct Address
{
  ...
  Address(
    ...
    mongo::OID const & oid = mongo::OID()) :   street (street),
    zipcode (zipcode),
    state (state),
    oid_ (oid) {
  }
...
struct Person
{
  ...
  Person(
    ...
    mongo::OID const & oid = mongo::OID()) :   name (name),
    age (age),
  ...
  {
    mongo::BSONArrayBuilder array_builder(builder__.subarrayStart("children"));
  ...
  {
    mongo::BSONArrayBuilder array_builder(builder__.subarrayStart("pet_names"));
    for(auto const& entry__ : pet_names) {
  array_builder.append(entry__);
    }
  }
  {
    mongo::BSONArrayBuilder array_builder(builder__.subarrayStart("pet_ages"));
...
#endif // __CONFIG_USERS_PERSON_HPP__
